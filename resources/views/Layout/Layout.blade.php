...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <!-- Sidebar -->
        <ul class="navbar-nav bg-gradient-videsa sidebar sidebar-dark accordion" id="accordionSidebar">
                    ...
                    <form
                        ...
                        <div class="input-group">
                            ...
                            <div class="input-group-append">
                                <button class="btn btn-videsa" type="button">
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Videsa 2025</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <form action="{{route('LogOut')}}" method="POST">
                        @csrf
                        <a class="btn btn-primary" onclick="this.closest('form').submit()">Salir</a>
                    </form>
